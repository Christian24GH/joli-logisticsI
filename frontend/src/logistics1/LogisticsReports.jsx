// src/logistics1/LogisticsReports.jsx
  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 p-6">
        <h1 className="text-2xl font-bold mb-6">Logistics Reports</h1>
                  ...
                  <div>
                    ...
                    <Select value={formData.report_type || ""} onValueChange={(value) => setFormData({...formData, report_type: value})}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Maintenance Overview">Maintenance Overview</SelectItem>
